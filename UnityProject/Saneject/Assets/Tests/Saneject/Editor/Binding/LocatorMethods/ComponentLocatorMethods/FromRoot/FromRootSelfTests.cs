...
{
    public class FromRootSelfTests
    {
        [Test]
        ...
        public void FromRootSelf_TInterface_InjectsToInterfaceField()
        {
            ...
            // Bind
            scope.BindComponent<IDependency>().FromRootSelf();
        ...
        [Test]
        public void FromRootSelf_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 3, depth: 3);
            scene.AddToAllTransforms<ComponentDependency>();
        ...
        [Test]
        public void FromRootSelf_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 3, depth: 3);
            TestScope scope = scene.Add<TestScope>("Root 1/Child 2/Child 3");
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromRootSelf();
