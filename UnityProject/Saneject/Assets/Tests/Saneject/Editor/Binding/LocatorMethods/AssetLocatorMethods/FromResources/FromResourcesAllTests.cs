...
namespace Tests.Saneject.Editor.Binding.LocatorMethods.AssetLocatorMethods.FromResources
{
    public class FromResourcesAllTests
    {
        [Test]
        ...
        [Test]
        public void FromResourcesAll_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 1, depth: 1);
            TestScope scope = scene.Add<TestScope>("Root 1");
            ...
            // Bind
            scope.BindAssets<AssetDependency>().FromResourcesAll("");
