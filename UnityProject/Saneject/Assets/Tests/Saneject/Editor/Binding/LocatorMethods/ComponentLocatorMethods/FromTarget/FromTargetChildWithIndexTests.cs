...
{
    public class FromTargetChildWithIndexTests
    {
        [Test]
        ...
        [Test]
        public void FromTargetChildWithIndex_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 3, depth: 3);
            scene.AddToAllTransforms<ComponentDependency>();
        ...
        [Test]
        public void FromTargetChildWithIndex_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 3, depth: 3);
            TestScope scope = scene.Add<TestScope>("Root 1");
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromTargetChildWithIndex(1);
        ...
        [Test]
        public void FromTargetChildWithIndex_WHEN_IndexIsOutOfRange_DoesNotThrowAndLogsMissingDependency()
        {
            // Expect logs
