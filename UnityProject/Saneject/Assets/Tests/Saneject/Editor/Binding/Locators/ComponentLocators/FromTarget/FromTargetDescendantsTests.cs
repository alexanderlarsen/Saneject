...
{
    public class FromTargetDescendantsWhenIncludeSelfIsFalseTConcreteTests
    {
        [Test]
    ...
    public class FromTargetDescendantsWhenIncludeSelfIsFalseTInterfaceTests
    {
        [Test]
    ...
    public class FromTargetDescendantsWhenIncludeSelfIsFalseTInterfaceTConcreteTests
    {
        [Test]
        public void FromTargetDescendants_WHEN_IncludeSelfIsFalse_TInterface_InjectsToInterfaceField()
        {
    ...
    public class FromTargetDescendantsWhenIncludeSelfIsTrueTConcreteTests
    {
        [Test]
    ...
    public class FromTargetDescendantsWhenIncludeSelfIsTrueTInterfaceTests
    {
        [Test]
    ...
    public class FromTargetDescendantsWhenIncludeSelfIsTrueTInterfaceTConcreteTests
    {
        [Test]
        public void FromTargetDescendants_WHEN_IncludeSelfIsTrue_TInterface_InjectsToInterfaceField()
        {
