...
{
    public class FromTargetChildWithIndexTConcreteTests
    {
        [Test]
    ...
    public class FromTargetChildWithIndexTInterfaceTests
    {
        [Test]
    ...
    public class FromTargetChildWithIndexTInterfaceTConcreteTests
    {
        [Test]
        public void FromTargetChildWithIndex_TInterface_InjectsToInterfaceField()
        {
