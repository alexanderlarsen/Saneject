...
{
    public class FromParentOfTests
    {
        [Test]
        ...
        public void FromParentOf_TInterface_InjectsToInterfaceField()
        {
            ...
            // Bind
            scope.BindComponent<IDependency>().FromParentOf(transform);
        ...
        [Test]
        public void FromParentOf_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 2, width: 3, depth: 3);
            scene.AddToAllTransforms<ComponentDependency>();
        ...
        [Test]
        public void FromParentOf_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 2, width: 3, depth: 3);
            TestScope scope = scene.Add<TestScope>("Root 1");
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromParentOf(transform);
