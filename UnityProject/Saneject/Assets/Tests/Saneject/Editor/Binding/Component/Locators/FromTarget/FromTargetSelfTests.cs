...
{
    public class FromTargetSelfTests
    {
        [Test]
        ...
        [Test]
        public void FromTargetSelf_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 3, depth: 2);
            scene.AddToAllTransforms<ComponentDependency>();
        ...
        [Test]
        public void FromTargetSelf_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 3, depth: 2);
            TestScope scope = scene.Add<TestScope>("Root 1");
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromTargetSelf();
