...
namespace Tests.Saneject.Editor.Binding.Component.Locators.Special
{
    public class FromMethodTests
    {
        ...
        [Test]
        public void FromMethod_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 2, width: 3, depth: 3);
            scene.Add<ComponentDependency>("Root 2/Child 3/Child 3");
        ...
        public void FromMethod_TConcrete_InjectsToConcreteCollection()
        {
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromMethod(() => scene.Get<ComponentDependency>("Root 2/Child 3/Child 3"));
