...
namespace Tests.Saneject.Editor.Binding.Components.Locators.FromScope
{
    public class FromScopeFirstChildTests
    {
        [Test]
        ...
        [Test]
        public void FromScopeFirstChild_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 1, depth: 3);
            scene.AddToAllTransforms<ComponentDependency>();
        ...
        [Test]
        public void FromScopeFirstChild_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 1, depth: 3);
            TestScope scope = scene.Add<TestScope>("Root 1");
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromFirstChild();
