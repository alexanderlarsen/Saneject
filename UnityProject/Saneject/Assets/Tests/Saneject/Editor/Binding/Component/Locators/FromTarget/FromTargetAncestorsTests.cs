...
namespace Tests.Saneject.Editor.Binding.Components.Locators.FromTarget
{
    public class FromTargetAncestorsTests
    {
        [Test]
        ...
        [Test]
        public void FromTargetAncestors_WHEN_IncludeSelfIsFalse_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 1, depth: 3);
            scene.AddToRoots<ComponentDependency>();
        ...
        [Test]
        public void FromTargetAncestors_WHEN_IncludeSelfIsTrue_TInterfaceTConcrete_InjectsToInterfaceField()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 1, depth: 3);
            scene.AddToRoots<ComponentDependency>();
        ...
        [Test]
        public void FromTargetAncestors_WHEN_IncludeSelfIsFalse_TConcrete_InjectsToConcreteCollection()
        {
            // Set up scene
            TestScene scene = TestScene.Create(roots: 1, width: 1, depth: 3);
            TestScope scope = scene.Add<TestScope>("Root 1");
            ...
            // Bind
            scope.BindComponents<ComponentDependency>().FromTargetAncestors(includeSelf: false);
