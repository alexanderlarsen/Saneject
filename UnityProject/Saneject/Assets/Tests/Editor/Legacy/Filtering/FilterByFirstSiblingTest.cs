...
{
    public class FilterByFirstSiblingTest
    {
        ...
        [Test]
        public void FiltersComponentByFirstSibling()
        {
            Assert.AreEqual("FirstChild", testFilterComponent.componentTarget.gameObject.name);
        }

        [Test]
        public void FiltersTransformByFirstSibling()
        {
            Assert.AreEqual("FirstChild", testFilterComponent.transformTarget.name);
        }
