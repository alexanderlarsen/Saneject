...
namespace Tests.Editor.Binding.AssetBinding.Locators.ProjectLoad
{
    public class FromResourcesTest : BaseBindingTest
    {
        ...
        public void InjectsConcrete_FromResources()
        {
            ...
            // Set up bindings
            scope.BindAsset<InjectableScriptableObject>().FromResources("Test/InjectableScriptableObject 1");
        ...
        public void InjectsInterface_FromResources()
        {
            ...
            // Set up bindings
            scope.BindAsset<IInjectable, InjectableScriptableObject>().FromResources("Test/InjectableScriptableObject 2");
