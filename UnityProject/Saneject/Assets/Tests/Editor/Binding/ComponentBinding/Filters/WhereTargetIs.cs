...
{
    public class FilterByTargetTypeTest : BaseBindingTest
    {
        ...
        public void InjectsComponentOnlyIntoMatchingTarget()
        {
            ...
            Requester requesterA = child3.AddComponent<Requester>();
            RequesterB requesterB = child4.AddComponent<RequesterB>();
        ...
        public void InjectsInterfaceOnlyIntoMatchingTarget()
        {
            ...
            // Add components
            TestScope scope = root.AddComponent<TestScope>();
            Requester requesterA = child5.AddComponent<Requester>();
            RequesterB requesterB = child6.AddComponent<RequesterB>();
            InjectableComponent componentA = child1.AddComponent<InjectableComponent>();
            InjectableComponent componentB = child2.AddComponent<InjectableComponent>();
