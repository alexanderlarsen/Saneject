...
namespace Tests.SanejectLegacy.Editor.Bindings.ComponentBinding.Locators.Target
{
    public class FromTargetAncestorsTest : BaseBindingTest
    {
        ...
        public void InjectsConcrete_IncludeSelfTrue()
        {
            ...
            // Set up bindings
            BindComponent<InjectableComponent>(scope).FromTargetAncestors(includeSelf: true);
        ...
        public void DoesNotInject_WhenOnlySelfPresentAndIncludeSelfFalse()
        {
            ...
            // Set up bindings
            BindComponent<InjectableComponent>(scope).FromTargetAncestors(includeSelf: false);
