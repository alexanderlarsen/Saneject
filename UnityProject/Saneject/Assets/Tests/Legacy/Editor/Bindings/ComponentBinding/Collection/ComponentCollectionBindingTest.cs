...
using UnityEngine;
using ComponentCollectionRequester = Tests.Legacy.Runtime.Component.ComponentCollectionRequester;

namespace Tests.Legacy.Editor.Bindings.ComponentBinding.Collection
{
