...
{
    /// <summary>
    /// Proxy ScriptableObject for <see cref="CameraController" />.
    /// Enables cross-scene or cross-prefab serialization of <see cref="IMainCamera" /> references.
    /// The Roslyn generator generates a <c>partial class</c> implementing the interfaces and forwards all calls/events to the resolved <see cref="CameraController" /> instance at runtime.
    /// </summary>
