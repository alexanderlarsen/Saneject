using System;
using Plugins.Saneject.Experimental.Runtime.Bindings.RuntimeProxy;
...
namespace Plugins.Saneject.Experimental.Runtime.Bindings.Component
{
    ...
    public class ComponentBindingBuilder<TComponent> : BaseComponentBindingBuilder<TComponent> where TComponent : class
    {
        ...
        /// <summary>
        /// Configures this binding to use a <see cref="Plugins.Saneject.Experimental.Runtime.Proxy.RuntimeProxy{T}"/> intermediary.
        /// <remarks>
