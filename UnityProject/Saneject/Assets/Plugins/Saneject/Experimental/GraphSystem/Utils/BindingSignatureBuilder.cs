...
namespace Plugins.Saneject.Experimental.GraphSystem.Utils
{
    public static class BindingSignatureBuilder
    {
        ...
        /// </summary>
        public static string GetBindingSignature(NewBinding binding)
        {
            return GetBindingSignature(
                isGlobal: binding is NewGlobalBinding,
                isAsset: binding is NewAssetBinding,
                isComponent: binding is NewComponentBinding,
                isProxy: binding is NewComponentBinding { ResolveFromProxy: true },
