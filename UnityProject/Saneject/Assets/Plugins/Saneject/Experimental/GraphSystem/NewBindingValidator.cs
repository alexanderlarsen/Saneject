...
using Plugins.Saneject.Experimental.GraphSystem.Editor;
using Plugins.Saneject.Runtime.Extensions;
using UnityEngine;

namespace Plugins.Saneject.Experimental.GraphSystem
{
    public static class NewBindingValidator
    {
            ...
            out List<BindingError> errors)
        {
            ...
            NewBinding binding = context.Binding;

            switch (binding)
            {
                case NewGlobalBinding globalBinding:
                {
                ...
                case NewComponentBinding componentBinding:
                {
                ...
                case NewAssetBinding assetBinding:
                {
