...
namespace Plugins.Saneject.Experimental.GraphSystem
{
    public abstract class NewScope : MonoBehaviour
    {
        ...
        /// <summary>
        /// Sets <see cref="HideFlags" /> to <see cref="HideFlags.DontSaveInBuild" />. If you override this method, call <c>base.OnValidate()</c> to strip <see cref="NewScope" /> from build.
        /// </summary>
        ...
        protected NewComponentBindingBuilder<T> BindComponents<T>() where T : class
        {
        ...
        /// <typeparam name="T">The concrete component type to bind as a collection.</typeparam>
        /// <returns>A fluent builder for configuring the component collection binding.</returns>
        protected NewComponentBindingBuilder<T> BindMultipleComponents<T>() where T : class
        {
            NewComponentBinding binding = new();
            binding.SetTargetType(typeof(T));
        ...
        /// <returns>A fluent builder for configuring the component binding.</returns>
        protected NewComponentBindingBuilder<TConcrete> BindComponent<TInterface, TConcrete>()
            ...
            where TInterface : class
        {
            ...
            componentBindings.Add(binding);
            return new NewComponentBindingBuilder<TConcrete>(binding);
        }
        ...
        /// <typeparam name="TConcrete">The concrete component type that implements the interface.</typeparam>
        /// <returns>A fluent builder for configuring the component collection binding.</returns>
        protected NewComponentBindingBuilder<TConcrete> BindComponents<TInterface, TConcrete>()
            where TConcrete : Component, TInterface
            where TInterface : class
        {
        ...
        /// <typeparam name="TConcrete">The concrete component type that implements the interface.</typeparam>
        /// <returns>A fluent builder for configuring the component collection binding.</returns>
        protected NewComponentBindingBuilder<TConcrete> BindMultipleComponents<TInterface, TConcrete>()
            where TConcrete : Component, TInterface
            where TInterface : class
        {
            NewComponentBinding binding = new();
        ...
        protected NewAssetBindingBuilder<TConcrete> BindAsset<TConcrete>() where TConcrete : Object
        {
            NewAssetBinding binding = new();
            binding.SetTargetType(typeof(TConcrete));
            assetBindings.Add(binding);
            return new NewAssetBindingBuilder<TConcrete>(binding);
        }
        ...
        protected NewAssetBindingBuilder<TConcrete> BindAssets<TConcrete>() where TConcrete : Object
        {
        ...
        /// <typeparam name="TConcrete">The UnityEngine.Object-derived asset type to bind as a collection.</typeparam>
        /// <returns>A fluent builder for configuring the asset collection binding.</returns>
        protected NewAssetBindingBuilder<TConcrete> BindMultipleAssets<TConcrete>() where TConcrete : Object
        {
            NewAssetBinding binding = new();
            binding.SetTargetType(typeof(TConcrete));
            binding.MarkCollectionBinding();
        ...
        /// <returns>A fluent builder for configuring the asset binding.</returns>
        protected NewAssetBindingBuilder<TConcrete> BindAsset<TInterface, TConcrete>()
        ...
        /// <typeparam name="TConcrete">The concrete asset type that implements the interface.</typeparam>
        /// <returns>A fluent builder for configuring the asset collection binding.</returns>
        protected NewAssetBindingBuilder<TConcrete> BindAssets<TInterface, TConcrete>()
            where TConcrete : Object, TInterface
            where TInterface : class
        {
        ...
        /// <typeparam name="TConcrete">The concrete asset type that implements the interface.</typeparam>
        /// <returns>A fluent builder for configuring the asset collection binding.</returns>
        protected NewAssetBindingBuilder<TConcrete> BindMultipleAssets<TInterface, TConcrete>()
            where TConcrete : Object, TInterface
            where TInterface : class
        {
            NewAssetBinding binding = new();
