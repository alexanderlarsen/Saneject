...
namespace Plugins.Saneject.Runtime.Bindings.Component
{
    ...
    {
        /// <summary> The search starts from the <see cref="Scopes.Scope" /> object. </summary>
        Scope,

        /// <summary> The search starts from the root of the <see cref="Scopes.Scope" /> hierarchy. </summary>
        Root,
