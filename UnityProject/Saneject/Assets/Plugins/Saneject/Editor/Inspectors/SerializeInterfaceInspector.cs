...
namespace Plugins.Saneject.Editor.Inspectors
{
    ...
    /// You can safely remove this class and call <see cref="SanejectInspectorUtils.DrawAllSerializedFieldsWithCorrectInterfaceOrder" />
    /// in your own inspector to preserve correct field ordering.
    /// </summary>
    [CustomEditor(typeof(MonoBehaviour), true), CanEditMultipleObjects]
    public class SerializeInterfaceInspector : UnityEditor.Editor
    {
