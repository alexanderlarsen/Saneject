...
namespace Plugins.Saneject.Editor.MenuItems
{
    ...
    public static class ProxyMenuItems
    {
        ...
        [MenuItem("Saneject/Runtime Proxy/Generate Missing Proxy Scripts", false, MenuPriority.SanejectMenu.RuntimeProxy.GenerateMissingProxyScripts)]
        private static void GenerateMissingProxyScripts()
        {
            RuntimeProxyScriptGenerator.GenerateMissingProxyScripts();
        }
        
        [MenuItem("Saneject/Runtime Proxy/Clean Up Unused Scripts And Assets", false, MenuPriority.SanejectMenu.RuntimeProxy.CleanUpUnusedScriptsAndAssets)]
