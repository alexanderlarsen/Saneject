...
namespace Plugins.SanejectLegacy.Runtime.Bindings
{
    /// <summary>
    ...
    public class ComponentBindingBuilder<TComponent> where TComponent : class
    {
        ...
        /// Only injection targets annotated with <see cref="InjectAttribute" />
        ...
        /// Injection target is the Transform of the <see cref="Component" /> of a field/property marked with <see cref="InjectAttribute" />.
        /// </summary>
