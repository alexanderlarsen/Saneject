...
namespace Plugins.SanejectLegacy.Runtime.Bindings
{
    ...
    public class Binding : IEquatable<Binding>
    {
        ...
        /// <summary>
        /// Marks this binding as a global singleton, making it eligible for use in <see cref="GlobalScope" /> resolution by adding it to a <see cref="SceneGlobalContainer" />.
        /// </summary>
