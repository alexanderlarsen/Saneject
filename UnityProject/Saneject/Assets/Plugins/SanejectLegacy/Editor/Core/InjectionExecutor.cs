...
using System.Linq;
using Plugins.SanejectLegacy.Editor.BatchInjection.Core;
using Plugins.SanejectLegacy.Editor.BatchInjection.Data;
using Plugins.SanejectLegacy.Editor.BatchInjection.Utilities;
using Plugins.SanejectLegacy.Editor.Extensions;
using Plugins.SanejectLegacy.Editor.Utility;
using Plugins.SanejectLegacy.Runtime.Extensions;
...
namespace Plugins.SanejectLegacy.Editor.Core
{
    ...
    /// <see cref="DependencyInjector" /> and <see cref="BatchInjector" />.
    /// </para>
    /// </summary>
